...
return [
    ...
    'events' => [
        'type_groups' => [
            'sports' => 'Hội thao',
            'academic_contest' => 'Hội thi học thuật',
            'movement_contest' => 'Hội thi phong trào',
        ],
        'types' => [
            'football' => 'Bóng đá',
            ...
            'school_excellent_student' => 'Học sinh giỏi cấp trường',
            'subject_olympic' => 'Olympic môn học',
            'stem' => 'STEM',
            'science_tech' => 'Khoa học kỹ thuật',
            'english_speaking' => 'Hùng biện tiếng Anh',
            'young_informatics' => 'Tin học trẻ',
            'music' => 'Văn nghệ',
            'wall_newspaper' => 'Báo tường',
            'flower_arrangement' => 'Cắm hoa',
            'school_beauty' => 'Nét đẹp học đường',
            'golden_bell' => 'Rung chuông vàng',
            'law_traffic' => 'Tìm hiểu pháp luật/an toàn giao thông',
        ],
        'statuses' => [
            'draft' => 'Nháp',
            'registration_open' => 'Mở đăng ký',
        ...
        'target_audiences' => [
            ...
            'grade_11' => 'Khối 11',
            'grade_12' => 'Khối 12',
            'selected_classes' => 'Lớp được chọn',
            'club_members' => 'Câu lạc bộ/đội tuyển',
        ],
        'scoring_modes' => [
            'sport' => 'Thi đấu thể thao',
            'judged' => 'Giám khảo chấm điểm',
            'time' => 'Xếp theo thời gian',
            'manual' => 'BTC nhập thủ công',
        ],
        'sport_rules' => [
            'football' => 'Bóng đá 3/1/0',
            'volleyball_best_of_three' => 'Bóng chuyền best-of-3',
            'badminton_best_of_three' => 'Cầu lông best-of-3',
            'shuttlecock_best_of_three' => 'Đá cầu best-of-3',
            'tug_of_war_best_of_three' => 'Kéo co best-of-3',
            'relay_time' => 'Chạy tiếp sức theo thời gian',
            'chess_swiss' => 'Cờ Swiss 5 ván',
            'judged_average' => 'Chấm điểm trung bình',
        ],
        'organizer_roles' => [
            'head' => 'Trưởng ban',
            'deputy' => 'Phó ban',
        ...
        'default_criteria' => [
            ['code' => 'quality', 'name' => 'Chất lượng chuyên môn', 'max_score' => 10, 'weight' => 1],
            ['code' => 'creativity', 'name' => 'Sáng tạo', 'max_score' => 10, 'weight' => 1],
            ['code' => 'presentation', 'name' => 'Trình bày/thể hiện', 'max_score' => 10, 'weight' => 1],
            ['code' => 'discipline', 'name' => 'Kỷ luật và đúng thể lệ', 'max_score' => 10, 'weight' => 1],
            ['code' => 'impact', 'name' => 'Hiệu quả/ý nghĩa', 'max_score' => 10, 'weight' => 1],
        ],
    ],
    ...
    'role_permissions' => [
        ...
        'phu_huynh' => ['dashboard.view', 'portal.view', 'conduct.conduct_scores.view', 'conduct.conduct_records.view', 'activities.campaigns.view', 'activities.campaign_participants.view', 'activities.campaign_results.view', 'activities.events.view', 'activities.event_registrations.view', 'activities.event_results.view', 'activities.event_awards.view', 'communication.announcements.view'],
        'hoc_sinh' => ['dashboard.view', 'portal.view', 'conduct.conduct_scores.view', 'conduct.conduct_records.view', 'activities.campaigns.view', 'activities.campaign_participants.view', 'activities.campaign_participants.create', 'activities.campaign_results.view', 'activities.events.view', 'activities.event_registrations.view', 'activities.event_registrations.create', 'activities.event_results.view', 'communication.announcements.view'],
    ],
    ...
    'resources' => [
        ...
        'events' => [
            ...
            'fields' => [['name' => 'school_year_id', 'label' => 'Nam hoc', 'type' => 'select', 'lookup' => $yearLookup, 'required' => true], ['name' => 'semester_id', 'label' => 'Hoc ky', 'type' => 'select', 'lookup' => $semesterLookup], ['name' => 'title', 'label' => 'Ten su kien', 'type' => 'text', 'required' => true], ['name' => 'event_type', 'label' => 'Loai', 'type' => 'select', 'options' => ['football' => 'Bong da', 'volleyball' => 'Bong chuyen', 'stem' => 'STEM', 'music' => 'Van nghe'], 'required' => true], ['name' => 'starts_at', 'label' => 'Bat dau', 'type' => 'datetime-local'], ['name' => 'ends_at', 'label' => 'Ket thuc', 'type' => 'datetime-local'], ['name' => 'status', 'label' => 'Trang thai', 'type' => 'select', 'options' => ['draft' => 'Nhap', 'registration_open' => 'Mo dang ky', 'in_progress' => 'Dang dien ra', 'ended' => 'Ket thuc', 'summarized' => 'Da tong ket'], 'required' => true], ['name' => 'description', 'label' => 'Mo ta', 'type' => 'textarea']],
